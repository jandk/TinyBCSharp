...
internal abstract class BPTCDecoder(BlockFormat format, int pixelStride) : BlockDecoder(format, pixelStride)
{
    ...
    private static readonly byte[] Anchor11 =
    [
    ...
    private static readonly byte[] Anchor21 =
    [
        +3, +3, 15, 15, +8, +3, 15, 15,
        +8, +8, +6, +6, +6, +5, +3, +3,
        +3, +3, +8, 15, +3, +3, +6, 10,
    ...
    private static readonly byte[] Anchor22 =
    [
        15, +8, +8, +3, 15, 15, +3, +8,
